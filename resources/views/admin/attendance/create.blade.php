                    ...
                    <form action="{{ route('attendance.store') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="check_in" id="check_in" class="form-control @error('check_in') is-invalid @enderror" value="{{ old('check_in') }}" placeholder="VD: 08:00, 13:00, 14:30">
                                @error('check_in')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="check_out" id="check_out" class="form-control @error('check_out') is-invalid @enderror" value="{{ old('check_out') }}" placeholder="VD: 17:00, 18:00, 20:30">
                                @error('check_out')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="check_in_location" id="check_in_location" class="form-control @error('check_in_location') is-invalid @enderror" value="{{ old('check_in_location') }}">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="check_out_location" id="check_out_location" class="form-control @error('check_out_location') is-invalid @enderror" value="{{ old('check_out_location') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="status" id="status" class="form-select @error('status') is-invalid @enderror" required>
                                ...
                                <option value="late" {{ old('status') == 'late' ? 'selected' : '' }}>Đi muộn</option>
                                <option value="early_leave" {{ old('status') == 'early_leave' ? 'selected' : '' }}>Về sớm</option>
